...
const AboutUs = () => {
  return (
    <section className="py-28 px-4 sm:px-6 bg-white/5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-14 items-stretch">
          ...
          <div className="flex flex-col justify-center text-white">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-5">
              Refined <span className="text-[#fe6200]">Cuisine</span> With Genuine <span className="text-[#fe6200]">Hospitality</span>
            </h2>
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4 max-w-md">
              <div className="rounded-xl border border-white/15 bg-white/5 px-3 py-4 text-center">
                <p className="text-xl sm:text-2xl font-bold text-[#fe6200]">10+</p>
              ...
              <div className="rounded-xl border border-white/15 bg-white/5 px-3 py-4 text-center">
                <p className="text-xl sm:text-2xl font-bold text-[#fe6200]">50k+</p>
                <p className="text-[11px] sm:text-xs text-white/80 tracking-wide">
                  Guests Hosted
                </p>
              </div>
              ...
              <div className="rounded-xl border border-white/15 bg-white/5 px-3 py-4 text-center">
                <p className="text-xl sm:text-2xl font-bold text-[#fe6200]">30+</p>
                <p className="text-[11px] sm:text-xs text-white/80 tracking-wide">
                  Signature Dishes
                </p>
              </div>
